...
\ac{SMRF}\cite{SMRF} from the PDAL library will be used to classify ground points in the point cloud data. 
...
\ac{Knn} \cite{knn} is used to impute missing data.
...
\begin{figure}
	\centering
	\includegraphics[width=0.8\textwidth]{geoai_knn_id2.png}
