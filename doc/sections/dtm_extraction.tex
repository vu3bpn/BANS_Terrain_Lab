...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\node[block, below of = smrf, node distance=3cm]  (transformer) {Encoder-Decoder transformer architecture for DTM extraction};
...
\begin{figure}
	...
	\begin{tikzpicture}
		...
		\node[block, right of = spatialwindow, node distance=4cm]  (transformer) {Encoder-Decoder transformer architecture for DTM extraction};
